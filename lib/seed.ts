...
export const SEED_ACTIVITIES: ProcessingActivity[] = [
  ...
  },
  {
    ...
    relationships: [
      { id: 'r-recert-talentsprint', type: 'vendor', name: 'TalentSprint AI', inventoryId: 'ven-talentsprint', provenance: 'ai', confidence: 0.98, status: 'accepted', note: 'Processor relationship inside the recruitment activity' },
      { id: 'r-recert-ats', type: 'vendor', name: 'Greenhouse', inventoryId: 'ven-greenhouse', provenance: 'manual', status: 'accepted' },
      { id: 'r-recert-checkr', type: 'vendor', name: 'Checkr', inventoryId: 'ven-checkr', provenance: 'manual', status: 'accepted' },
      { id: 'r-recert-screening', type: 'asset', name: 'TalentSprint Screening Console', inventoryId: 'ast-screening', provenance: 'ai', confidence: 0.94, status: 'accepted' },
      { id: 'r-recert-video', type: 'asset', name: 'Recorded Interview Workspace', inventoryId: 'ast-video', provenance: 'manual', status: 'accepted' },
      pdcRel('pdc-name', 'Name'),
      pdcRel('pdc-email', 'Email address'),
      pdcRel('pdc-phone', 'Phone number'),
      pdcRel('pdc-govid', 'Government ID number'),
    ...
    sourceDocuments: [
      { id: 'sd-recert-brief', name: 'TalentSprint AI rollout brief.pdf', kind: 'Project brief', addedAt: iso(-18), excerpt: 'Resume ranking and recorded interview scoring introduced to the existing recruitment process.' },
      { id: 'sd-recert-dpia', name: 'Candidate screening DPIA.docx', kind: 'DPIA', addedAt: iso(-10), excerpt: 'Human review, candidate notice, and challenge pathways are required before deployment.' },
      { id: 'sd-recert-dpa', name: 'TalentSprint AI DPA.pdf', kind: 'Vendor contract', addedAt: iso(-8) },
    ],
    createdWithAI: true,
    updatedWithAI: true,
    reviewCadenceDays: 180,
