...
function FigmaKpiCard({ children }: { children: React.ReactNode }) {
  return (
    <Card className="h-full min-h-[260px] rounded-xl border-[#e6e5e2] bg-white shadow-none">
...
function ProgressBar({ value, color }: { value: number; color: string }) {
  return (
    <div className="h-[5px] overflow-hidden rounded-full bg-[#e6e5e2]">
